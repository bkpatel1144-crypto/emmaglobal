...
export const Route = createFileRoute("/services/")({
  head: () => {
    ...
    return {
      ...
      links,
      scripts: [
        jsonLd(breadcrumbJsonLd([{ name: "Services", path: "/services" }])),
  ...
  return (
    <>
      ...
      <CtaBand
        ...
        text="Describe the problem rather than the category. We'll tell you which of the services — or which combination — actually addresses it."
